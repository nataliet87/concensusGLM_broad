...
file_inputs <- list(data=file.path('eachanjohnson-concensusGLM-e884c65/tests/input/count-data.csv'),
                    annotation=file.path('eachanjohnson-concensusGLM-e884c65/tests/input/annotations.csv'))
